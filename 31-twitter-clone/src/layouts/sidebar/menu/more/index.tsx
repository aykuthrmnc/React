...
const More = () => {
  return (
    <Popover className="relative">
      <Popover.Button className="group block py-[3px] outline-none">
        <div className="inline-flex items-center gap-5 rounded-full p-3 transition-colors group-hover:bg-[color:var(--background-third)]">
      ...
      <Popover.Panel className="absolute bottom-0 left-0 w-[318px] overflow-hidden rounded-xl bg-[color:var(--background-primary)] shadow-box">
        <button className="inline-flex h-14 w-full items-center gap-5 px-4 transition-colors hover:bg-[color:var(--background-third)]">
          <div className="relative h-[1.641rem] w-[1.641rem]">
            <svg viewBox="0 0 24 24" className="h-[1.641rem]">
              <path
                fill="currentColor"
        ...
        <div className="my-2px mx-auto h-px w-[89%] bg-[color:var(--background-third)]" />

        <Disclosure>
          {({ open }) => (
            <>
              <Disclosure.Button className="flex h-[52px] w-full items-center justify-between px-4 font-bold transition-colors hover:bg-[color:var(--background-third)]">
              ...
              <Disclosure.Panel>
                <Link
                  to="/"
                  className="flex h-11 items-center gap-3 px-3 font-medium transition-colors hover:bg-[color:var(--background-third)]"
                >
            ...
            <>
              ...
              <Disclosure.Panel>
                ...
                <button
                  ...
                  className="flex h-11 w-full items-center gap-3 px-3 font-medium transition-colors hover:bg-[color:var(--background-third)]"
                >
                  <svg viewBox="0 0 24 24" className="h-[1.172rem]">
                    <path
                      fill="currentColor"
